<!-- Provenance: vendored copy of codex-pair/TOKEN_OPTIMIZATION_RESEARCH.md,
     the gold-standard forward-spec output. Copied 2026-07-06 (T2-F2) so
     forward-spec no longer hard-couples to a file inside another skill.
     Re-sync from source only if the original materially changes. -->
